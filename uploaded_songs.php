<?php
	...
	if(isset($_POST['upload'])){
		...
		if(isset($_FILES['audio_file'])){
			...
			move_uploaded_file($file_tmp,"songs/upload_songs/".$file_name);
		 }
...
<head>
	<title>Musical World | Upload Songs</title>
		...
		<div class="container">
			<nav class="navbar navbar-expand-lg navbar-light">
                ...
                <li class="nav-item">
                    ...
                    <p style="color:blue;">| Upload Songs |</p>
                </li>
					...
					echo "
							<div class='col-md-3'>
								<form method='post' action='uploaded_songs.php'>
									<div class='card-deck'>
										<div class='card-img'>
											<img src='songs/upload_songs/img/$song_image' style='width:350px;height:250px;' alt=''>
										</div>
										<div class='card-desc'>
											<h3>$song_name | $singer_name</h3>
											<audio class='embed-responsive-item' controls='' preload='none'> <source src='songs/upload_songs/$audio_file' type='audio/mp3'></audio><br>
